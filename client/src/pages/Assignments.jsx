        ...
        <div className="space-y-6">
            <div className="flex items-center justify-between">
                ...
                {(role === 'teacher' || role === 'admin') && (
                    <Link to="/app/assignments/create" className="btn-primary">
                        Create Assignment
                    </Link>
                )}
            </div>
                ...
                {assignments.map(assignment => (
                    <div key={assignment._id} className="card hover:shadow-md transition-shadow">
                        <div className="flex items-start justify-between mb-3">
                            <span className="badge badge-purple">File Upload</span>
                        ...
                        <h3 className="font-semibold text-gray-900 dark:text-gray-100 mb-2">{assignment.title}</h3>
                        ...
                        {assignment.submission && (
                            <div className="mb-4 p-2 bg-green-50 rounded-lg">
                                <p className="text-sm text-green-700">
                                    Grade: {assignment.submission.grade || 'Pending'} / {assignment.points}
                                </p>
                            </div>
                        )}

                        <Link
                            to={`/app/assignments/${assignment._id}`}
